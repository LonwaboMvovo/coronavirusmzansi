...
ZAF1188.addEventListener('click', () => {
    ...
    province_breakdown.textContent = 'Cases: 15 Deaths: 0 Recoveries: 0';
    for (i = 0; i < 9; i++) {
...
ZAF1189.addEventListener('click', () => {
    ...
    province_breakdown.textContent = 'Cases: 541 Deaths: 6 Recoveries: 152';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1201.addEventListener('click', () => {
    ...
    province_breakdown.textContent = 'Cases: 18 Deaths: 0 Recoveries: 3';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1206.addEventListener('click', () => {
    ...
    province_breakdown.textContent = 'Cases: 94 Deaths: 3 Recoveries: 61';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1208.addEventListener('click', () => {
    ...
    province_breakdown.textContent = 'Cases: 801 Deaths: 3 Recoveries: 157';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1209.addEventListener('click', () => {
    ...
    province_breakdown.textContent = 'Cases: 20 Deaths: 0 Recoveries: 6';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1210.addEventListener('click', () => {
    ...
    province_breakdown.textContent = 'Cases: 24 Deaths: 0 Recoveries: 13';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1216.addEventListener('click', () => {
    ...
    province_breakdown.textContent = 'Cases: 412 Deaths: 12 Recoveries: 15';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1926.addEventListener('click', () => {
    ...
    province_breakdown.textContent = 'Cases: 68 Deaths: 0 Recoveries: 3';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
