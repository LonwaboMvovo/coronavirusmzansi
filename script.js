...
async function fetchCoronaSaSummary() {
    try {
        ...
        console.log(err);
        last_updated_desktop.textContent = 'Last Updated: 03/05/2020';
        last_updated_mobile.textContent = 'Last Updated: 03/05/2020';
        number[0].innerHTML = '245747';
        number[1].innerHTML = '6783';
        number[2].innerHTML = '4103';
        number[3].innerHTML = '2549';
        number[4].innerHTML = '36';
        number[5].innerHTML = '131';
        death_rate.innerHTML = '1.93%';
        recovery_rate.innerHTML = '37.58%';
    }
}
...
async function fetchGlobalCoronaSaSummary() {
    try {
        ...
        console.log(err);
        global_number[0].innerHTML = '3545197';
        global_number[1].innerHTML = '1148830';
        global_number[2].innerHTML = '247305';
        selected_death_rate.innerHTML = '6.98%';
        selected_recovery_rate.innerHTML = '32.41%'
    }
}
...
ZAF1188.addEventListener('click', () => {
    ...
    province_breakdown.innerHTML = 'Cases: 36<br>Deaths: 0<br>Recoveries: 20';
    for (i = 0; i < 9; i++) {
...
ZAF1189.addEventListener('click', () => {
    ...
    province_breakdown.innerHTML = 'Cases: 3044<br>Deaths: 58<br>Recoveries: 779';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1206.addEventListener('click', () => {
    ...
    province_breakdown.innerHTML = 'Cases: 122<br>Deaths: 6<br>Recoveries: 96';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1208.addEventListener('click', () => {
    ...
    province_breakdown.innerHTML = 'Cases: 1624<br>Deaths: 14<br>Recoveries: 948';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1209.addEventListener('click', () => {
    ...
    province_breakdown.innerHTML = 'Cases: 46<br>Deaths: 0<br>Recoveries: 18';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1210.addEventListener('click', () => {
    ...
    province_breakdown.innerHTML = 'Cases: 37<br>Deaths: 2<br>Recoveries: 25';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1216.addEventListener('click', () => {
    ...
    province_breakdown.innerHTML = 'Cases: 1076<br>Deaths: 34<br>Recoveries: 375';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
...
ZAF1926.addEventListener('click', () => {
    ...
    province_breakdown.innerHTML = 'Cases: 774<br>Deaths: 17<br>Recoveries: 275';
    for (i = 0; i < 9; i++) {
        provinces[i].style.fill = 'black';
    }
